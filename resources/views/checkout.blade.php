				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="your-order">
							...
							<div class="your-order-head"><h5>How to pay<t/h5></div>
							
							<div class="your-order-body">
								<ul class="payment_methods methods">
									<li class="payment_method_bacs">
										<input id="payment_method_bacs" type="radio" class="input-radio" name="payment_method" value="COD" checked="checked" data-order_button_text="">
										<label for="payment_method_bacs">Pay when received </label>
									...
									<li class="payment_method_cheque">
										...
										<label for="payment_method_cheque">Pay method </label>
							...
							<div class="text-center"><a class="beta-btn primary" href="{{Route('checkout')}}">Continue checkout <i class="fa fa-chevron-right"></i></a></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
