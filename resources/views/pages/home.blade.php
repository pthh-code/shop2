								...
								<div class="col-sm-3">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('ProductDetail',$new->id)}}"><img src="{{asset('source/image/product/'.$new->image)}}" alt="" height="250px"></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="#">Detail<i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
